...
// Detects client-side mount without the render/effect/setState cascade a
// `useState` + `useEffect(() => setMounted(true))` pair causes — React
// swaps the snapshot at the right point in hydration on its own.
